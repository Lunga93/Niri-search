...
import * as preview from './components/preview.ts';
import * as actionmenu from './components/actionmenu.ts';
import * as picked from './components/picked.ts';
import * as banner from './components/banner.ts';
import * as health from './components/health.ts';
import * as confirm from './components/confirm.ts';
import * as commands from './screens/commands/index.ts';
import * as todoCmd from './screens/commands/todo.ts';
import { listChecks } from './icons.ts';
import * as settings from './screens/settings.ts';
import { mountUpdateWidget } from './screens/update_widget.ts';
import * as translatePanel from './components/translate.ts';
import * as runningApps from './components/running-apps.ts';
import * as superactions from './components/superactions.ts';
import * as sourceblocks from './components/sourceblocks.ts';
import * as levels from './levels.ts';
import * as smoothcaret from './components/smoothcaret.ts';
import * as platform from './platform.ts';
import * as motion from './motion.ts';
import * as aiAnswer from './components/ai-answer.ts';
import { State as AiState } from './components/ai-answer.ts';
import * as aiCard from './components/ai-answer-card.ts';
import * as layout from './layout.ts';
import { load } from './html-loader.ts';
import {
    onWindowShown,
    onWindowHidden,
    confirmHide,
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const hintMessage = document.getElementById('hint-message') as HTMLElement;
    const contentArea = document.getElementById('search-content') as HTMLElement;
    const resultsArea = document.getElementById('results-area') as HTMLElement;
    const aiCardEl = document.getElementById('ai-answer-card') as HTMLElement;
    const helpScreen = document.getElementById('help-screen') as HTMLElement;
    const previewCol = document.getElementById('preview-col') as HTMLElement;
    const breadcrumbEl = document.getElementById('search-breadcrumb') as HTMLElement;
    const placeholderEl = /** @type {HTMLElement|null} */ (document.querySelector('.search-placeholder'));
    const previewFooter = document.getElementById('preview-footer') as HTMLElement;
    ...
    resultsList.addEventListener('result-activate', () => {
        ...
        switch (classified?.kind) {
            ...
            case 'commandSuggestion':
                ...
                return;
            case 'calc':
                import('./ipc.ts').then(({ copyToClipboardLabeled, hideWindow }) =>
            ...
            case 'webSuggestion': {
                ...
                import('./ipc.ts').then(({ openPath }) => openPath(url, 'browser', ''));
                return;
            }
            case 'webUrl':
                import('./ipc.ts').then(({ openPath, recordUrlHit }) => {
        ...
        import('./ipc.ts').then(({ openPath, recordUsage }) => {
