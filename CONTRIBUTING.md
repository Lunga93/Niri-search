...
[DEVELOPMENT.md](DEVELOPMENT.md) has the full prerequisites and build walkthrough. In short: Rust stable plus GNU Make everywhere, and the WebKitGTK/GTK system libraries on Linux (or `nix develop` on NixOS).
